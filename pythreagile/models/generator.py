...
class ModelGenerator:
    ...
    def create_stub_model(self) -> None:
        ...
        model = {
            ...
            'technical_assets': {
                'Some Technical Asset': self._create_technical_asset(
                    'some-component',
                    ['some-data'],
                    {'Some Traffic': self._create_communication_link('some-other-component', ['some-data'])}
                ),
                'Some Other Tecnical Asset': self._create_technical_asset(
            ...
            'individual_risk_categories': {
                'Some Individual Risk Example': self._create_individual_risk()
            },
